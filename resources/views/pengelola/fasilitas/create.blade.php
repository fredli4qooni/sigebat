    ...
    <div class="space-y-6 max-w-3xl mx-auto">
        ...
        <x-papan warna="biru" class="p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold font-papan text-putih">Tambah Fasilitas Baru</h2>
                    <p class="text-putih/90 text-sm mt-1">
                        Daftarkan musala, toilet umum, pos ronda, area parkir, atau fasilitas penunjang lainnya.
                    </p>
                </div>
                <a
        ...
        <div class="bg-putih border-2 border-aspal rounded-papan p-6">
            ...
            >
                ...
                <div>
                    ...
                    <x-text-input id="nama" name="nama" type="text" :value="old('nama')" required placeholder="Contoh: Toilet Umum & Ruang Bilas" />
                ...
                <div>
                    ...
                    <x-text-input id="keterangan_lokasi" name="keterangan_lokasi" type="text" :value="old('keterangan_lokasi')" required placeholder="Contoh: Samping Balai Adat / Gerbang Masuk Kampung" />
                    <x-input-error :messages="$errors->get('keterangan_lokasi')" />
                </div>

                <div>
                    <x-input-label for="deskripsi" value="Deskripsi / keterangan kondisi (opsional)" />
                    <textarea
                        id="deskripsi"
                        name="deskripsi"
                        rows="3"
                ...
                <div>
                    <x-input-label for="foto" value="Foto fasilitas (opsional, maks. 3 MB)" />
                    <input
                        type="file"
                        id="foto"
                        name="foto"
                    ...
                    <template x-if="previewUrl">
                        <div class="mt-3 p-2 bg-beton/40 border border-aspal rounded-kontrol">
                            <span class="block text-[11px] font-bold text-abu mb-1">Pratinjau foto:</span>
                            <img :src="previewUrl" alt="Pratinjau" class="w-full h-40 object-cover rounded-kontrol border border-aspal">
                        </div>
                    </template>
                </div>
